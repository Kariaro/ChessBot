...
//			}
	...
	private static Scan0 analyseFrom(ChessBoard board, int depth) {
		return analyseBranchMoves(board, depth);
	}
	...
	private static Scan0 analyseBranchMoves(ChessBoard board, int depth) {
		...
		for (Move move : moves) {
			...
			scan.branches.add(new Move0(percent, move));
